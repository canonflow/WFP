...
<html lang="en">
  ...
  <head>
    ...
    <title>{{ $title ?? "Dashboard" }} | canonflow</title>
      ...
      <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
        ...
        <div class="sidebar-brand">
          ...
          <a href="./index.html" class="brand-link">
            ...
            <!--end::Brand Image-->
            <!--begin::Brand Text-->
            <span class="brand-text fw-light">canonflow</span>
            <!--end::Brand Text-->
          </a>
          <!--end::Brand Link-->
        </div>
            ...
            >
              <li class="nav-item menu-open">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="{{ route('foods.index') }}" class="nav-link {{ (Route::currentRouteName() == 'foods.index') ? 'active' : '' }}">
